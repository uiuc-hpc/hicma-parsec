...
#for N in 10800000 11880000 12960000; do 
for N in 11880000 12960000; do 
    for type in 0; do

if [ $type -eq 0 ]; then
        if [ $N -eq 10800000 ]; then
            NB=2700
        elif [ $N -eq 11880000 ]; then
            #NB=3000
            NB=3375
        elif [ $N -eq 12960000 ]; then
            NB=3375
        fi
fi
