...
memory_thd=250.0
# First run
for N in 1080000 `seq 2160000 2160000 12960000`; do
    time_opt=1000000000
    # All 
    ...
    for NB in 2400 2700 3000 3375 3600 4000 4500 5000 5400 6000 7200 9000 10000 10800 12000 15000 18000 20000 21600; do
        if [ $(($NB/2)) -lt 1800 ]; then
           maxrank=$(($NB/2))
           genmaxrank=$(($NB/2))
           compmaxrank=$(($NB/2))
        else
