...
memory_thd=250.0
# First run
for N in `seq 1080000 2160000 12960000`; do
    time_opt=1000000000
    # All 
    ...
    for NB in 1800 2400 2700 3000 3375 3600 4500 5000 5400 6000 7200 9000 10000 10800 12000 15000 18000 20000 21600; do
