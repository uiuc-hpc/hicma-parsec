...
#SBATCH --output=/project/k1205/lei/lorapo/experiments/D1w100/out/%j
#SBATCH --error=/project/k1205/lei/lorapo/experiments/D1w100/out/%j
...
numnodes=32; nummpi=32; ntasks_per_node=1; nthread=32; p=8; q=4
core=31
...
for opt_combine in "--band 0 -F 1 -Y 0" "--band 1 -F 1 -Y 0" "--band 1 -F 0 -Y 0" "--band 1 -F 0 -Y 1" "--band 1 -F 0 -Y 1"; do
  ...
  # First run
for N in 1080000 `seq 2160000 2160000 4320000`; do
    time_opt=1000000000
    # All 
    ...
    for NB in 2700 3375 3600 4500 5400 7200 9000 10800; do
