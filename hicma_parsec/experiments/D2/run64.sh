...
#SBATCH --output=/project/k1205/lei/lorapo/experiments/D2/out/%j
#SBATCH --error=/project/k1205/lei/lorapo/experiments/D2/out/%j
...
for N in 8640000; do
    ...
    for NB in 3375 3600 4500 5400 7200 9000 10800; do
