...
# First run
for N in 1080000 `seq 2160000 2160000 14800000`; do
    time_opt=1000000000
    ...
    # First run 
    for NB in 3375 3600 4500 5400 7200 9000 10000 10800 12000 15000 18000 20000; do

    # Second run
    #for NB in 3375 3600 4000 4500 5000 5400 5400 7200 9000 10800 12000 15000 18000 20000; do
