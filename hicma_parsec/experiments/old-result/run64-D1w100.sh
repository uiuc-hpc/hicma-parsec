...
# Second run
for N in `seq 8640000 1080000 12800000`; do
    time_opt=1000000000
    ...
    # First run 
    #for NB in 3375 3600 4500 5400 7200 9000 10800 12000 15000 18000 20000; do

    # Second run
    for NB in 10800 12000 15000 18000 20000; do
