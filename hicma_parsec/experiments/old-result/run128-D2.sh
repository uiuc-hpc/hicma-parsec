...
# Second run
for N in `seq 12960000 2160000 28800000`; do
    time_opt=1000000000
    ...
    # First run 
    #for NB in 3375 3600 4000 4500 5000 5400 6000 7200 9000 10000 10800 12000 15000 18000 20000; do

    # Second run
    # 12M can not run 7200
    for NB in 5400 9000 10800 12000 15000 18000 20000; do
