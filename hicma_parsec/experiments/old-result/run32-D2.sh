...
# Second run
for N in `seq 12960000 1080000 16800000`; do
    time_opt=1000000000
    # All
    ...
    # First run 
    #for NB in 2700 3600 4500 5400 7200 9000 10000 10800 12000 15000 18000 20000; do

    # Second run
    for NB in 9000 10000 10800 12000 15000 18000 20000; do
