...
# Second run
for N in `seq 12960000 2160000 38800000`; do
    time_opt=1000000000
    ...
    # First run 
    #for NB in 1500 1800 2400 2700 3375 3600 4000 4500 5000 5400 6000 7200 9000 10000 10800 12000 15000 18000 20000; do

    # Second run
    for NB in 4500 5400 6000 7200 9000 10800 12000 15000 18000 20000; do
