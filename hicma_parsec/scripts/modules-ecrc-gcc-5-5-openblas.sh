...
module load cmake
module load gcc/5.5.0 openmpi/3.0.0-gcc-5.5.0
#module load openblas/0.2.20-gcc-5.5.0
module load openblas/0.2.20-gcc-5.5.0-singlethread
module load plasma/2.8.0-gcc-5.5.0-openblas hwloc/1.11.8-gcc-5.5.0
module load parsec/master-gcc-5.5.0-openblas-openmpi-plasma-2.8.0
